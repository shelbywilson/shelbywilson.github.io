	...
	render() {
		return (
			<div className='container'>
				...
				<p>
					Clicking 'edit' will take you to the <a href='/v1/patterns/builder' target='_blank'>pattern builder</a> module. As the patterns are edited, the url is updated with a sharable encoded pattern.
				</p>
				<p>
